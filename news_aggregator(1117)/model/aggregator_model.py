...
class Database:
    ...
    def set_raw_all(cls, temp, H_url, title, news_text, search_job_id):
        ...
        for i in range(len(temp)):
            try:
                ...
                sql = "insert into newinfo_raw(posted_time, title, URL,search_job_id, text) values('" + TmStamp + "','" + TTitle + "','" + HUrl + "','" + str(
                    search_job_id) + "','" + TText + "')"
                conn.query(sql)
    ...
    def set_simifre(cls, temp, H_url, title, news_text, frequency, search_job_id):
        ...
        for i in range(len(temp)):
            try:
                ...
                TTitle = fix(TTitle)
                TText = fix(TText)
                sql = "insert into newinfo_simifre(posted_time, title, URL, search_job_id,text, similatiry_fre) values('" + TmStamp + "','" + TTitle + "','" + HUrl + "','" + str(
    ...
    @classmethod
    def set_vip_raw(cls, v_name, temp, H_url, title, news_text, re_tweet, like):
